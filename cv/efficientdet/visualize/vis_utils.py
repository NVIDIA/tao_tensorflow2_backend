...
from cv.efficientdet.visualize import shape_utils
from cv.efficientdet.visualize import standard_fields as fields
...
class VisualizeSingleFrameDetections(EvalMetricOpsVisualization):
    ...
    def images_from_evaluation_dict(self, eval_dict):
        """Draw images from evalution dict."""
...
def denormalize_image(image):
    ...
    """
    scale = np.array([0.229, 0.224, 0.225])[None][None]  # TODO(@yuw): change to 0.224
