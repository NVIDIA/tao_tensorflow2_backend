...
from nvidia_tao_tf2.model_optimization.quantization.qdq_layer import QDQ
from nvidia_tao_tf2.model_optimization.quantization.quantized_conv2d import QuantizedConv2D
from nvidia_tao_tf2.model_optimization.quantization.quantized_conv2dtranspose import QuantizedConv2DTranspose
from nvidia_tao_tf2.model_optimization.quantization.quantized_depthwiseconv2d import QuantizedDepthwiseConv2D
...
def create_quantized_keras_model(model):
    ...
    for layer in model.layers:
        ...
        inbound_layers = [in_layer.name
                          for in_layer in _convert_to_list(inbound_node.inbound_layers)]
