...
import iva.common.logging.logging as status_logging
...
def run_export(Exporter, args, backend="uff"):
    ...
    if output_file is None:
        ...
        output_file = "{}.etlt".format(split_name)
    ...
    status_logger.write(status_string="Building exporter object.")
    ...
    status_logger.write(status_string="Exporting the model.")
...
def launch_export(Exporter, args=None, backend="uff"):
    ...
    from iva.common.export.app import build_command_line_parser  # noqa pylint: disable=W0611
    from iva.common.export.app import launch_export
    from iva.X.export.X_exporter import XExporter as Exporter
