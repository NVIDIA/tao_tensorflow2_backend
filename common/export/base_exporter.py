...
from iva.common.export.tensorfile_calibrator import TensorfileCalibrator
from iva.common.export.trt_utils import (
    NV_TENSORRT_MAJOR,
    NV_TENSORRT_MINOR,
    NV_TENSORRT_PATCH
)
from iva.common.logging import logging as status_logging
...
class BaseExporter(object):
    ...
    def __init__(self, model_path=None,
        ...
        # if key is str, it will be converted to bytes in magnet.encoding
        self.key = key
    ...
    def generate_ds_config(self, input_dims, num_classes=None):
        ...
        Returns:
            ds_config (iva.common.types.base_ds_config.BaseDSConfig): Deepstream config element.
        """
        raise NotImplementedError(
    ...
    def get_calibrator(self,
        ...
        Returns:
            calibrator (iva.common.export.base_calibrator.TensorfileCalibrator):
