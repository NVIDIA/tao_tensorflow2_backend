...
class APEvaluator:
    ...
    def __call__(self, gt, pred, verbose=True):
        '''
    ...
    def __voc_ap(self, rec, prec, average_precision_mode, num_recall_points):
    ...
    def _calc_ap(self, sorting_algorithm, average_precision_mode, num_recall_points):
        ...
        for T, P in zip(self.T, self.P):
            ...
            ap = self.__voc_ap(np.array(rec), np.array(prec), average_precision_mode,
                               num_recall_points)
